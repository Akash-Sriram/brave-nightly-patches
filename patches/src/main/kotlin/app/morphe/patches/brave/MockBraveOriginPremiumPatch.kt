...
val braveOriginPatch = bytecodePatch(
    ...
    execute {
        ...
        // ── 1. hasValidSubscriptionTokens(Profile) → true ───────────────────────────
        ...
        // ── 2. getIsSubscriptionActive(Profile) → true ───────────────────────────────
        Fingerprint(
            ...
            custom = { method, _ -> method.name != validSubscriptionMethod },
        ...
        // ── 4. v42.a(Profile, String) / (String, Profile) → skip ──────────────────────
        Fingerprint(
            returnType = "V",
            parameters = listOf(
